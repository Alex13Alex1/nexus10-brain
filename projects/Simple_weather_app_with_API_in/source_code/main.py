...
if __name__ == "__main__":
    ...
    if validate_data(weather_data):
        ...
        display_current_weather(parsed_weather)
    else:
        log_error("Invalid weather data")

    if validate_data(forecast_data):
        parsed_forecast = parse_weather_data(forecast_data)
        display_forecast(parsed_forecast)
    else:
        log_error("Invalid forecast data")