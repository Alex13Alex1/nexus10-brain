...
- **Error Message**: 
  ```
  can't open file 'C:\\Users\\alexs\\brain\\projects\\URL_shortener_with_custom_alia\\source_code\\projects\\URL_shortener_with_custom_alia\\source_code\\main.py': [Errno 2] No such file or directory
  ```
