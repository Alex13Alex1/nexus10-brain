...
- **Error Message**: 
  ```
  can't open file 'C:\\Users\\alexs\\brain\\projects\\Todo_list_manager_with_priorit\\source_code\\projects\\Todo_list_manager_with_priorit\\source_code\\main.py': [Errno 2] No such file or directory
  ```
